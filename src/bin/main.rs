use sell_a_maze::{generator::Generator, randomness::Randomness, rectangular_builder, triangular_builder, svg_painter::paint_shapes, 
    cairo::CairoFiles};
...
fn main() {
  ...
  let builder = triangular_builder::Builder::new(50);
