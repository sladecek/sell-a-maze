...
impl GoogleJobStorage {
    ...
    pub async fn save_async(id: Uuid, job: &Job) -> io::Result<()>
     {
    ...
    pub fn save(id: Uuid, job: &Job) -> io::Result<()>
     {
        let content = serde_json::to_string(job)?.as_bytes().to_vec();
    ...
    pub async fn load_async(id: Uuid) -> io::Result<Job> {
    ...
    pub fn load(id: Uuid) -> io::Result<Job> {
